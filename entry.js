...
core.Config.set('visionTaskTimeoutMs', z.number().step(1000).min(1000).max(6000000).default(600000))
core.Config.set('visionTurnBudgetMs', z.number().step(1000).min(0).max(6000000).default(6000000))
