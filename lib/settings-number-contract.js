export const SETTINGS_NUMBER_META = Object.freeze({
  timeoutMs: Object.freeze({ min: 1000, max: 6000000, step: 1 }),
  visionTaskTimeoutMs: Object.freeze({ min: 1000, max: 180000, step: 1000 }),
  ocrTimeoutMs: Object.freeze({ min: 1000, max: 6000000, step: 1 }),
  ...
  visionTurnBudgetMs: Object.freeze({ min: 0, max: 6000000, step: 1000 }),
})
